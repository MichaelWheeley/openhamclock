...
| History Playback    | _(next release)_ Scrub through the last 24h of DX spots — timeline slider, 5–60 min window, play/pause with speeds up to 15 min/s, paths colored by band. History records from server start; the control shows how far back it goes. | —   |
